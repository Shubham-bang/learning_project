...
@section ('title') Add New Product - Admin Dashboard @endsection 
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Product Requirement</h5>
            ...
            <form action="{{ route('admin.product_update') }}" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Choose Product Category</label>
                  <div class="col-sm-10">
                    <select name="category_id" id="" class="form-control">
                      <option selected disabled>Please choose product category</option>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Choose Product Status</label>
                  <div class="col-sm-10">
                    <select name="category_id" id="" class="form-control">
                      <option selected disabled>Please choose product status</option>
                      @if($product->status == '1')
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="formFile" name="pro_img">
                  </div>
                </div>
