...
@section ('title') Update  Category - Admin Dashboard @endsection 
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Category Requirement</h5>
              ...
              <form action="{{ route('admin.cate_update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Cate Icon (Optional)</label>
                  <div class="col-sm-10">
